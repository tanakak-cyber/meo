        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('masters.sales-persons.update', $salesPerson) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $salesPerson->name) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $salesPerson->email) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $salesPerson->phone) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $salesPerson->display_order) }}" min="0"
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $salesPerson->is_active) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('masters.sales-persons.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                                キャンセル
                            </a>
